...
createpost("1.0 Offical Release!","This is the first release of Quickblog.js. I hope you all like it. You can check the docs for information on how to install. We have moved all files to a github respitory. Hosting was too much of a hastle.","10/10/2021")
var docs = "Welcome to the quickblog.js docs! This page is dedicated to setting up your blog!" 

var docs1 = "<h1>Setup</h1>Goto the offical <a href='https://github.com/brodyking/quickblog.js/releases'>GitHub Repo</a> download the newest release"
...
var docs4 = '<h1>Creating a extra page.</h1>Like writing a post, type <code>createpage("","") Inside the first bracket, type the title, and in the second braket, type the body. Refresh and see the page. <b>You can only make a maximum of one custom page.</b>'
